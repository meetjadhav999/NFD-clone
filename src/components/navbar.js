...
function Navbar() {
    ...
    const toggleClasses = () =>{ 
            if(window.scrollY>1){
                setNavClasses({
                    navbar:'navbar snav',
                    navbarContent:'navbar-content snav-content',
                    logoColor:'logocolor slogocolor',
                    linkColor:'nav-links snavlinks',
                    otherlinks:'other-links sother-links'
                })
            }
            else{
                setNavClasses({
    ...
    return (
        <div className={navClasses.navbar}>
            <div className={navClasses.navbarContent}>
                <div className='logo'>
                ...
                <div className={navClasses.otherlinks}>
                    <a href=''>
                        <button>
                            <div className='otherlink-div1'>
                            </div>
                            <div className='otherlink-div2'>
                                <p>"Combine" Software</p>
                            </div>
                            <div className='otherlink-div3'>
                            </div>
                        </button>
